 ...
 */
public class BubbleAnimationClockController implements ClockPlugin {
     ...
     */
    public BubbleAnimationClockController(Resources res, LayoutInflater inflater,
    ...
    public String getTitle() {
        return mResources.getString(R.string.clock_title_bubble_animation);
    }
